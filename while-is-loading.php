		...
		?>
			<div class="wrap">
				...
				<div id="postimagediv">
					...
					<small>You can show your appreciation leaving a <a href="https://wordpress.org/support/plugin/while-it-is-loading/reviews/">review</a>.</small>
				</div>
			</div>
		<?php
		}
